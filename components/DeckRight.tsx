...
interface DeckRightProps {
  audioEngine: AudioEngine;
  track: TrackInfo | null;
  onTrackLoad: (track: TrackInfo) => void;
}

export function DeckRight({ audioEngine, track, onTrackLoad }: DeckRightProps) {
  ...
  const deck = audioEngine.getDeck('right');
  ...
  const handleSync = () => {
    setSyncActive(true);
    const leftDeck = audioEngine.getDeck('left');
    deck.sync(leftDeck.bpm);
